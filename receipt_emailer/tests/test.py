...
class EmailerTestCase(unittest.TestCase):
    def test_verify_args(self):
        ...
        self.assertTrue(
            receipt_emailer.verify_argv(
                "module",
                "receipt_emailer/tests/single_invoice.txt",
                "SMIJO 0",
    ...
    def test_select_customer_invoices(self):
        ...
        self.assertEqual(
            len(receipt_emailer.select_customer_invoices(single_invoice, "SMIJO 0")), 1
        )
        ...
        self.assertEqual(
            len(receipt_emailer.select_customer_invoices(multiple_invoices, "SMIJO 0")),
            4,
        )
    ...
    def test_fix_invoice_number(self):
        ...
        self.assertEqual(
            receipt_emailer.fix_invoice_number("000000", day_of_mill_invoice), "1000000"
        )
        self.assertEqual(
            receipt_emailer.fix_invoice_number("900000", day_of_mill_invoice), "900000"
        )
        self.assertEqual(
            receipt_emailer.fix_invoice_number("900000", day_before_invoice), "900000"
        )
        self.assertEqual(
            receipt_emailer.fix_invoice_number("900000", day_after_invoice), "1900000"
        )
